...
python run_hw3_ql.py env.exp_name=${exp_name} alg.rl_alg=td3 env.env_name=HalfCheetah-v2 alg.td3_target_policy_noise=$td3_target_policy_noise alg.td3_target_policy_noise_clip=$td3_target_policy_noise_clip num_agent_train_steps_per_iter=$num_agent_train_steps_per_iter env.atari=False double_q=False
