...
# python run_hw4_gcrl.py env.env_name=reacher env.exp_name=q4_reacher_normal_k10 env.distribution=normal env.k=10 env.task_name=gcrl_v2 logging.save_params=true alg.n_iter=6000
# python run_hw4_gcrl.py env.env_name=reacher env.exp_name=q4_reacher_normal_k5 env.distribution=normal env.k=5 env.task_name=gcrl_v2 logging.save_params=true alg.n_iter=1800

# # Q5: Normal distribution, Hierarchical RL for Reacher with k=5
# echo "Running Q5 for Reacher..."
# python run_hw4_gcrl.py env.env_name=reacher env.task_name=hrl env.distribution=normal env.exp_name=q5_reacher_hrl__gf10 env.k=10 env.distribution=normal env.relative_goal=true  alg.n_iter=400
# python run_hw4_gcrl.py env.env_name=reacher env.task_name=hrl env.distribution=normal env.exp_name=q5_reacher_hrl_gf5 env.k=5 env.distribution=normal env.relative_goal=true  alg.n_iter=400
...
python run_hw4_gcrl.py env.env_name=widowx env.exp_name=q4_widowx_normal_k10 env.distribution=normal env.k=10 env.task_name=gcrl_v2 logging.save_params=true alg.n_iter=1800
python run_hw4_gcrl.py env.env_name=widowx env.exp_name=q4_widowx_normal_k5 env.distribution=normal env.k=5 env.task_name=gcrl_v2 alg.n_iter=1800


# # Q5: Normal distribution, Hierarchical RL for Reacher with k=5
# echo "Running Q5 for Reacher..."
# python run_hw4_gcrl.py env.env_name=widowx env.task_name=hrl env.distribution=normal env.exp_name=q5_widowx_hrl_gf10 env.k=10 env.distribution=normal env.relative_goal=true  alg.n_iter=400
# python run_hw4_gcrl.py env.env_name=widowx env.task_name=hrl env.distribution=normal env.exp_name=q5_widowx_hrl_gf5 env.k=5 env.distribution=normal env.relative_goal=true  alg.n_iter=400